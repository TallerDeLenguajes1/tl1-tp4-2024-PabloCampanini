...
void cambiarLista(Nodo **ListaPendientes, Nodo **ListaRealizadas, int ID);
...
void cambiarLista(Nodo **ListaPendientes, Nodo **ListaRealizadas, int ID)
{
    ...
    else
    {
        ...
        Nodo *auxPrevio;
        Nodo *mover;
        while (aux->Siguiente && aux->Siguiente->T.TareaID != ID)
        {
            aux = aux->Siguiente;
        }
        ...
        else
        {
            ...
            auxPrevio->Siguiente = NULL;

            moverFinal(ListaRealizadas, auxPrevio);
        }
    }
}
...
void moverListaUsuario(Nodo **ListaPendientes, Nodo **ListaRealizadas)
{
    ...
    while (cargar == 1)
    {
        ...
        cambiarLista(ListaPendientes, ListaRealizadas, ID);
